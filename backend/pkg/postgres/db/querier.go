...
type Querier interface {
	...
	GetVehicleForVerification(ctx context.Context, id uuid.UUID) (GetVehicleForVerificationRow, error)
	GetVehicleForVerificationByChassisNumber(ctx context.Context, chassisNumber string) (GetVehicleForVerificationByChassisNumberRow, error)
	...
	ListEventsForVerification(ctx context.Context, vehicleID uuid.UUID) ([]ListEventsForVerificationRow, error)
